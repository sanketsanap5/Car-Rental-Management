...
begin
   ...
   --pckg_customer.insert_customer(786,'Ganesh','Nayak','ganesh.n@northeastern.edu',3456987098,'ZXCVB542','LKJHGMN678','EMPLOYEE','02-JUL-1997');
    ...
    --UPDATE CUSTOMER
    --pckg_customer.update_customers(786,'Naveen','Hks','naveen@gmail.com','3456988098','ZXC9VB542','LKJH8GMN678','EMPLOYEE','02-JUL-2006');
    ...
    --INSERT PICKUP POINT pickup point id, state, city, zip, cost, name
        --pckg_car.insert_pickup_point(-1, 'TEXAS','AUSTIN','92115', 50000, 'AUSTIN_A1');
    ...
    --INSERT CARS AT PICK UP 
        --pckg_car.insert_cars_at_pickup(15,-1,500);
    ...
    --INSERT RIDE Transaction -  Trans id, cust id, car at pickup id, start, end, car id, distance, status
        --pckg_transact.insert_ride_transaction(1, 4000, 15, to_timestamp((sysdate)), to_timestamp((sysdate+1/24)),500, 0, 'IN PROCESS');
    
    --UPDATE  Ride Transaction- Trans id, car at pickup id, start, end, car id, distance, status, customer card, discount id
       --pckg_transact.update_ride_transaction(17, 15, to_timestamp((sysdate+1/24)), to_timestamp((sysdate+3/24)), 500, 0,'UPDATED',NULL, NULL);
...
begin
    ...
    --pckg_car.insert_car(1052, 'SEDAN', 4, 16, 'CITY', 'HONDA','QQR D78', 15800);
        --pckg_car.update_car(1052, 'SEDAN', 4, 16, 'CITY', 'HONDA','QIR D78', 15800);
end;*/